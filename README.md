...
| **2** | **Corpus bíblico completo, Lector, Favoritos, Historial, Configuración, export/import** ← aquí |
| 3 | Bible Engine v1 (lexicon + tags + Top-K + MMR) |
